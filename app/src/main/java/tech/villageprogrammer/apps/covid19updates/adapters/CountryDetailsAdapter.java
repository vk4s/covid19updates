package tech.villageprogrammer.apps.covid19updates.adapters;
...
import tech.villageprogrammer.apps.covid19updates.AffectedCountryListActivity;
import tech.villageprogrammer.apps.covid19updates.R;
import tech.villageprogrammer.apps.covid19updates.models.CountryModel;

public class CountryDetailsAdapter extends ArrayAdapter<CountryModel> {
    Context context;
    List<CountryModel> countryModelsList, countryModelsListFiltered;
    public CountryDetailsAdapter(@NonNull Context context, List<CountryModel> countryModelsList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        countryName.setText(countryModelsListFiltered.get(position).getCountryName());
        Glide.with(context).load(countryModelsListFiltered.get(position).getFlag()).into(countryFlag);
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                AffectedCountryListActivity.countryModelList = (List<CountryModel>) results.values;
